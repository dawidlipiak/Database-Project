...
public class Admin {
    ...
    public String execute() throws SQLException {
        ...
        System.out.println("1 - Podgląd pojazdów");
        System.out.println("2 - Podgląd historii wypożyczeń");
        System.out.println("3 - Dodaj nowy pojazd");
        System.out.println("4 - Dodaj nowego klienta");
        System.out.println("5 - Dodaj nowego pracownika");
        System.out.println("6 - Usuń pracownika");
        ...
        switch (choice) {
            ...
            case "4" :
                ...
                int result2 = statement.executeUpdate(String.format("INSERT INTO clients(first_name,last_name,phone_number,pesel, birthday, street,  city, zip_code ,  company, NIP) VALUES ('%s', '%s', %s, '%s', '%s', '%s', '%s', '%s', '%s', '%s')",imie, naz, numer, pesel, data, ulica, miasto, kod, firma, nip));                if (result2 > 0) {
                    System.out.println("successfully inserted");
                }
                else {
                    System.out.println("unsucessful insertion ");
