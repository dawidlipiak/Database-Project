    ...
    public String execute() throws SQLException {
        ...
        switch (choice) {
            ...
            case "4" :
                ...
                int result2 = statement.executeUpdate(String.format("INSERT INTO clients(first_name,last_name,phone_number,pesel, birthday, street,  city, zip_code ,  company, NIP) VALUES ('%s', '%s', %s, '%s', '%s', '%s', '%s', '%s')",imie, naz, numer, pesel, data, ulica, miasto, kod, firma, nip));                if (result2 > 0) {
                System.out.println("successfully inserted");
            }
            else {
                System.out.println("unsucessful insertion ");
